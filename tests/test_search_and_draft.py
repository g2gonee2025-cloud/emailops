...
class TestParseFilterGrammar:
    ...
    def test_multiple_from_filters(self):
        ...
        filters, cleaned = parse_filter_grammar(
            "from:user1@example.com from:user2@example.com query"
        )
    ...
    def test_quoted_values(self):
        ...
        filters, cleaned = parse_filter_grammar(
            'subject:"quoted subject" from:"user name" query'
        )
    ...
    def test_case_insensitive_keys(self):
        ...
        filters, cleaned = parse_filter_grammar(
            "SUBJECT:test FROM:user@example.com query"
        )
    ...
    def test_mixed_filters_and_text(self):
        ...
        filters, cleaned = parse_filter_grammar(
            "subject:meeting from:user@example.com urgent meeting notes -draft"
        )
