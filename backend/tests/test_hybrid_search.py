...
class TestHybridSearch:
    ...
    @patch("cortex.retrieval.fts_search.search_chunks_fts", new_callable=AsyncMock)
    ...
    @patch("cortex.config.loader.get_config")
    @patch("cortex.db.session.SessionLocal")
    @patch("cortex.retrieval.fts_search.search_messages_fts", new_callable=AsyncMock)
    @patch("cortex.retrieval.fts_search.search_chunks_fts", new_callable=AsyncMock)
    @patch("cortex.retrieval.vector_search.search_chunks_vector")
