...
from cortex.security.auth import configure_jwt_decoder, extract_identity
...
class TenantUserMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(
        ...
        tenant_id, user_id, claims = await extract_identity(request)
...
def setup_security(app: FastAPI) -> None:
    ...
    try:
        ...
        configure_jwt_decoder(jwks_url=jwks_url, audience=audience, issuer=issuer)
