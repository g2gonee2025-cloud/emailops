...
try:
    ...
    logger.warning("Microsoft Presidio not found. PII redaction will be limited to regex-based fallback.")
...
class PIIEngine:
    ...
    def __init__(self, 
        ...
        if _HAS_PRESIDIO:
            try:
                ...
                logger.info(f"PIIEngine initialized with Presidio. Entities: {len(self.entities)}")
    ...
    def _build_operators(self) -> None:
        ...
        self._operators["DEFAULT"] = _OperatorConfig(
            "replace",
            {"new_value": ENTITY_PLACEHOLDERS["DEFAULT"]}
        )
