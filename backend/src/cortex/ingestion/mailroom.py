...
def process_job(job: IngestJob) -> IngestJobSummary:
    ...
    try:
        ...
        if job.source_type == "local_upload":
            ...
            from cortex.chunking.chunker import chunk_text, ChunkingInput, Span
            ...
            subject = manifest.get("subject_label") or summary_json.get("subject") or convo_dir.name
            ...
            if message_data["body_plain"]:
                body_chunks = chunk_text(ChunkingInput(
            ...
            for att in attachments_data:
                if att["text"]:
                    att_chunks = chunk_text(ChunkingInput(
                        text=att["text"],
