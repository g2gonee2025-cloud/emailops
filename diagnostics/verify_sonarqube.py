...
def check_sonarqube_health():
    ...
    try:
        ...
        results["errors"].append(f"Web UI connection error: {e!s}")
    ...
    try:
        ...
        results["errors"].append(f"System status error: {e!s}")
    ...
    try:
        ...
        results["errors"].append(f"Database status error: {e!s}")
...
def main():
    ...
    if container_running:
        print("✓ SonarQube container is running")
    ...
    if container_running and not wait_for_sonarqube():
    ...
    if all_good:
        ...
        print("  Access the web interface at: http://localhost:9000")
        print("  Default credentials: admin/admin (change after first login)")
