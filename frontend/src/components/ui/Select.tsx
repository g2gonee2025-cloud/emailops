...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "dark:bg-white/5 dark:border-white/10 dark:text-white dark:focus:ring-blue-500/50",
      className
    )}
    {...props}
  >
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "bg-gray-900 border-white/10 text-white", // Hardcoded dark theme for consistency
        position === "popper" &&
